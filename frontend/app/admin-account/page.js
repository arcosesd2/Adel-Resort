        ...
        <div className="flex items-center gap-6">
          <div className="relative group">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 w-8 h-8 bg-slate-700 text-white rounded-full flex items-center justify-center shadow-md hover:bg-slate-800 transition-colors"
            >
              <Camera size={14} />
            </button>
            <input
      ...
      <form onSubmit={handleSave} className="glass-card p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="text"
              value={user.is_superadmin ? 'Super Admin' : 'Staff'}
              disabled
          ...
          <div>
            ...
            {user.email && !user.email_verified && (
              <button
                ...
                className="mt-1.5 text-sm text-slate-600 hover:text-slate-700 font-medium flex items-center gap-1"
              >
                <Mail size={14} />
