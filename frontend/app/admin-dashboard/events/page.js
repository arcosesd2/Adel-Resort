      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="font-serif text-2xl font-bold text-gray-900">Manage Events</h1>
          </div>
        ...
        {items.length === 0 ? (
          <div className="card p-12 text-center text-gray-500">No events yet.</div>
        ) : (
            ...
            {items.map(item => (
              <div key={item.id} className="card p-4 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500">{format(parseISO(item.date), 'MMM d, yyyy')}</p>
                </div>
