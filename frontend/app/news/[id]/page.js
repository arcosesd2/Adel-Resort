    ...
    return (
      <div className="min-h-screen pt-24 pb-16 bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 text-center py-20">
          ...
          <h1 className="font-serif text-3xl font-bold text-gray-900 mb-3">News article not found</h1>
          <p className="text-gray-500 mb-6">This article may have been removed or is no longer available.</p>
          <Link href="/news" className="btn-primary inline-flex items-center gap-1.5">
