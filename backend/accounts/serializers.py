...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'username', 'first_name', 'last_name', 'phone', 'email',
                  ...
                  'bypass_device_authorization')
        read_only_fields = ('id', 'username', 'date_joined', 'is_staff', 'is_admin', 'is_superadmin',
                            'bypass_device_authorization', 'email_verified', 'avatar_url')
...
class UserManagementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'username', 'first_name', 'last_name', 'phone', 'email',
                  ...
                  'bypass_device_authorization', 'device_count', 'login_count', 'last_login')
